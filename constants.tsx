...
export const INITIAL_DATA: Node[] = [
  ...
  { 
    ...
    type: 'file', 
    parentId: 'f-videos', 
    content: '<p>A deep exploration into the nature of the Messianic era based on the teachings of Maimonides and Chassidic philosophy.</p>', 
    contentType: 'video', 
  ...
  { 
    ...
    type: 'file', 
    parentId: 'f-videos', 
    content: '<p>Insights into the daily mitzvah of "Anticipating the Redemption" and its practical application in our generation.</p>', 
    contentType: 'video', 
